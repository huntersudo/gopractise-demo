...
// [going@dev pflag_1]$ go run example1.go -h
...
//      --host string                 MySQL service host address. (default "127.0.0.1")
//  -m, --log.mode                    Start gorm debug mode.
//  -p, --password string             Password for access to mysql, should be used pair with password. (default "root")
//      --port int                    MySQL service host port. (default 3306)
//  -t, --timeout duration            Timeout when connecting to mysql service. (default 10s)
//      --username string[="colin"]   Username for access to mysql service. (default "root")
